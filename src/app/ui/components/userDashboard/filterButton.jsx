...
export default function FilterButton() {
	...
	const openRouteRegister = () => {
		router.push('/routeRegister');
	};
		...
		<div className='relative w-fit py-5 flex justify-around items-center gap-2 sm:gap-5'>
			...
			{pathname === '/driverDashboard' && (
				...
				>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						className='h-[20px] w-[20px] sm:h-[33px] sm:w-[33px] transform scale-x-[-1] scale-y-[-1]'
						viewBox='0 0 24 24'
					>
						<path
							fill='white'
							d='M4 15V8.5a4.5 4.5 0 0 1 9 0v7a2.5 2.5 0 0 0 5 0V8.83a3.001 3.001 0 1 1 2 0v6.67a4.5 4.5 0 1 1-9 0v-7a2.5 2.5 0 0 0-5 0V15h3l-4 5l-4-5z'
						/>
					</svg>
					Publicar ruta
				</button>
